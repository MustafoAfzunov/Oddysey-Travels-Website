...
const Home = () => {
    ...
    return (
        <section className="relative min-h-[100dvh] bg-forest-deep font-display text-white flex flex-col items-center justify-center text-center px-6 pt-28 pb-20 md:pt-32 md:pb-24 overflow-hidden">
            ...
            <div className="relative z-20 w-full max-w-4xl mx-auto flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full sm:w-auto">
                    <Link
                        to="/destinations"
                        className="w-full sm:w-auto px-10 py-4 bg-primary text-white rounded-2xl font-bold transition-colors hover:bg-primary/90 shadow-xl shadow-primary/20"
                    >
                        {t('home.explore_map')}
                    </Link>
                    <Link
